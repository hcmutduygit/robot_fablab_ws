...
options = {
  ...
  map_frame = "map",
  -- tracking_frame = "laser",  -- Đổi từ base_footprint sang laser
  -- published_frame = "odom",  -- Đổi từ base_footprint sang odom
  tracking_frame = "base_footprint",
  published_frame = "base_footprint",
  odom_frame = "odom",
  provide_odom_frame = false,  -- Tắt vì đã có odom từ encoder
  ...
  pose_publish_period_sec = 0.05,  -- 50ms = 20Hz (giảm từ 5ms = 200Hz)
...
TRAJECTORY_BUILDER_2D.num_accumulated_range_data = 1  -- Giảm từ 2 xuống 1
