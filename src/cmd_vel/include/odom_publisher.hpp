...
// //     float quaternion_yaw_degree = quaternion_yaw * 180.0 / PI;
// //     float delta = (yaw_prev == 0) ? 0.0 : abs(abs(quaternion_yaw_degree) - abs(yaw_prev));
// //     if (delta > 30) {
// //         quaternion_yaw = yaw_prev * PI / 180.0;
// //         qx = qx_prev;
// //         qy = qy_prev;
// //         qz = qz_prev;
// //         qw = qw_prev;
// //     }
// //     else {
// //         yaw_prev = quaternion_yaw_degree;
// //         qx_prev = qx;
// //         qy_prev = qy;
// //         qz_prev = qz;
// //         qw_prev = qw;
...
// //         float r = v / omega;
// //         // std::cout << "dyaw: " << dyaw << "\n";
// //         x += r * (sin(quaternion_yaw + dyaw) - sin(quaternion_yaw));
// //         y += -r * (cos(quaternion_yaw + dyaw) - cos(quaternion_yaw));
// //     }
